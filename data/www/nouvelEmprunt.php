...
if (isset($_POST['submit'])) {
    ...
    $debut = $db->real_escape_string($_POST['date-debut']);
    $fin = $db->real_escape_string($_POST['date-fin']);
    $materiel = $db->real_escape_string($_POST['materiel']);
    $idUtilisateur = $_SESSION['id'];

    $query = "INSERT INTO emprunt (utilisateurs, materiels, dateattribution, daterestitution) VALUES ('$idUtilisateur', '$materiel', '$debut', '$fin');";
        ...
        <div class="container">
            ...
            <form class="row needs-validation" novalidate method="post">
                ...
                <div class="input-group mb-3">
                    ...
                    <input id="date-debut" name="date-debut" type="datetime-local" class="form-control" aria-describedby="basic-addon1" required>
                ...
                <div class="input-group mb-3">
                    ...
                    <input id="date-fin" name="date-fin" type="datetime-local" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" required>
                    <div class="invalid-feedback">
                ...
                <div class="input-group mb-3">
                    ...
                    <select name="materiel" class="form-select" aria-label="Default select example" required>
                        <option selected disabled value="">Selectionnez un object</option>
                        <?php 
                        $result = $db->query("SELECT * FROM materiels");

                        while($row = $result->fetch_array(MYSQLI_ASSOC)) { 
                            ?>
                        <option value="<?php echo $row['id'] ?>"> <?php echo $row['nomdumateriel']?> </option>
